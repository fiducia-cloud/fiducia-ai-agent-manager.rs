...
//! makes retries after an ambiguous ACK or process restart safe. Connections
//! require TLS for any non-loopback broker (see [`tls_policy`]); credentials
//! come from `NATS_CREDS_FILE`, never the URL.
