...
//! subjects, tenant or message identifiers, payloads, tokens, or transport and
//! I/O error text. The existing `tracing` events remain the detailed record.
...
fn options() -> Options {
    ...
    Options {
        app_name: "fiducia-ai-agent-manager".into(),
        name: Some("nats-outbox".into()),
        runtime: "rust".into(),
